...
- Name: phase1-closeout.spec.ts >> dashboard and provider-health show matching provider truth chips/messages in demo fallback mode
- Location: tests\e2e\phase1-closeout.spec.ts:157:5
...
Locator: getByText('demo_fallback')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('demo_fallback')
