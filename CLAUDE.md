...
Test counts are point-in-time audit observations, not invariants — counts move as new tests land. Most recent observation (`docs/audit/roadmap-reality-2026-05-07.md`, `python -m pytest --collect-only -q`): pytest **473** collected; vitest **243**; Playwright **32**; tsc clean. Prior 2026-05-05 audit-fixes observation was 469 / 243 / 32; earlier `2026-04-30: 271 / 199 / 31` notes were stale.
